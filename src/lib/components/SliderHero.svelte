...
<div class="w-full h-98 relative overflow-hidden">
	{#key currentSlide.id}
		<button
			...
			<h1 class="text-4xl">{currentSlide.title}</h1>
		</button>
	{/key}
	<button
		class="w-full h-98 relative bg-linear-to-t from-secondary-600/80 to-80% flex flex-col items-center justify-around"
		onclick={nextSlide}>
